  ...
  methods: {
    ...
    navigateTo(id, offset) {
      return new Promise((resolve, reject) => {
        ...
        let deep = " ";
        deep = ">>>";
        const selector = common_vendor.index$1.createSelectorQuery().in(this._in ? this._in.page : this).select((this._in ? this._in.selector : "._root") + (id ? `${deep}#${id}` : "")).boundingClientRect();
        if (this._in) {
    ...
    getRect() {
      return new Promise((resolve, reject) => {
        common_vendor.index$1.createSelectorQuery().in(this).select("#_root").boundingClientRect().exec((res) => res[0] ? resolve(res[0]) : reject(Error("Root label not found")));
      });
    },
    /**
     * @description 暂停播放媒体
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "F:/uniapp-project/search-uniapp/uni_modules/mp-html/components/mp-html/mp-html.vue"]]);
