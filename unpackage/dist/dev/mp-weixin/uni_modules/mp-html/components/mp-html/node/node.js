...
const block0 = {};
const node = () => Promise.resolve().then(() => RjovdW5pYXBwLXByb2plY3Qvc2VhcmNoLXVuaWFwcC91bmlfbW9kdWxlcy9tcC1odG1sL2NvbXBvbmVudHMvbXAtaHRtbC9ub2RlL25vZGUudnVl);
const _sfc_main = {
  name: "node",
  options: {
    virtualHost: true
  ...
  data() {
    return {
      ctrl: {},
      isiOS: common_vendor.index$1.getSystemInfoSync().system.includes("iOS")
    };
  },
  props: {
    name: String,
  ...
  methods: {
    ...
    play(e) {
      ...
      if (this.root.pauseVideo) {
        ...
        if (!flag) {
          const ctx = common_vendor.index$1.createVideoContext(
            id,
            this
          );
          ctx.id = id;
        ...
        if (href[0] === "#") {
          ...
          if (this.root.copyLink) {
            common_vendor.index$1.setClipboardData({
              data: href,
              success: () => common_vendor.index$1.showToast({
                title: "链接已复制"
              })
            });
          }
...
if (typeof block0 === "function")
  block0(_sfc_main);
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "F:/uniapp-project/search-uniapp/uni_modules/mp-html/components/mp-html/node/node.vue"]]);
wx.createComponent(Component);
const RjovdW5pYXBwLXByb2plY3Qvc2VhcmNoLXVuaWFwcC91bmlfbW9kdWxlcy9tcC1odG1sL2NvbXBvbmVudHMvbXAtaHRtbC9ub2RlL25vZGUudnVl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null
